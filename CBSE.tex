...
\item  $\int_{0}^{1} tan(sin^{-1}x)$dx equals
...
(D) $ {\frac{\lfloor 100} {(100)^{100}}} $
\item $\int {\frac{cos 8x+1}{tan 2x- cot 2x}}$ dx= $\lambda$ cos8x+c,then the value of $\lambda$ is
